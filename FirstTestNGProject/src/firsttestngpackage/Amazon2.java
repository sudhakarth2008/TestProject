  ...
  public void setBaseURL() throws IOException
	{
	  ...
	  String HelloSignIn= prop.getProperty("HelloSignIn");
	 String Email = prop.getProperty("Email");
	  String EmailContinue = prop.getProperty("EmailContinue");
	  String PassWord = prop.getProperty("PassWord");
	  String Login= prop.getProperty("Login");
      String LogoutMenuInvoke= prop.getProperty("LogoutMenuInvoke");
	  String LogoutLink= prop.getProperty("LogoutLink");
	 ...
	 driver.findElement(By.xpath(Email)).sendKeys("sudhakarth2008@gmail.com");
	 driver.findElement(By.xpath(EmailContinue)).click();
	driver.findElement(By.xpath(PassWord)).sendKeys("babli1234");
	 driver.findElement(By.xpath(Login)).click();
	  ...
	  WebElement ele1=driver.findElement(By.xpath(LogoutMenuInvoke));
      ...
      WebElement ele2=driver.findElement(By.xpath(LogoutLink));
